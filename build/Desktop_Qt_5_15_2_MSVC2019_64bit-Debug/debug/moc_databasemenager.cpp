/****************************************************************************
** Meta object code from reading C++ file 'databasemenager.h'
**
...
#include <memory>
#include "../../../databasemenager.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'databasemenager.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(8, 69, 18), // "QList<QVariantMap>"
QT_MOC_LITERAL(9, 88, 11), // "getAllTasks"
QT_MOC_LITERAL(10, 100, 8), // "editList"
QT_MOC_LITERAL(11, 109, 2) // "id"

    },
    "DatabaseManager\0addList\0\0name\0description\0"
    "addTask\0listId\0getAllLists\0"
    "QList<QVariantMap>\0getAllTasks\0editList\0"
    "id"
};
...
static const uint qt_meta_data_DatabaseManager[] = {
 ...
 // methods: parameters
    ...
    QMetaType::Bool, QMetaType::Int, QMetaType::QString, QMetaType::QString,   11,    3,    4,
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->addTask((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: { QList<QVariantMap> _r = _t->getAllLists();
            if (_a[0]) *reinterpret_cast< QList<QVariantMap>*>(_a[0]) = std::move(_r); }  break;
        case 3: { QList<QVariantMap> _r = _t->getAllTasks((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< QList<QVariantMap>*>(_a[0]) = std::move(_r); }  break;
